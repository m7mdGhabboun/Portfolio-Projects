...
* Exploratory Data Analysis (EDA) on COVID-19 deaths and vaccinations datasets.
...
* The **United States** had the highest total death count, followed by **Brazil** and **Mexico**.
...
* Run the provided SQL scripts/queries to reproduce the analysis and insights.
